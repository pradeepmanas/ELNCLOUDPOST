...
INSERT into lsusermaster(userfullname, username, password, lastloggedon, passwordexpirydate, userstatus, lockcount, createddate, modifieddate, createdby, modifiedby, labsheet, emailid, profileimage, profileimagename, verificationcode, lssitemaster_sitecode, lsusergroup_usergroupcode,loginfrom) VALUES (N'Administrator', N'Administrator', 'gyX57EHs08KuakyVhFVvGQ==', CAST(N'2020-03-18T18:57:44.127' AS date), NULL, N'A         ', 0, CAST(N'2020-01-21T18:35:23.080' AS date), NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, 1, 1,'0')
